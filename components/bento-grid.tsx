...
import { Heart, Flame, Music, Users } from "lucide-react";
...
const features = [
  {
    ...
    description: "Gerakan Zumba membakar hingga 500 kalori per sesi",
    accent: "#AFFF00",
  },
  {
    icon: Flame,
    title: "Seru",
    subtitle: "Penuh Energi",
    description: "Diiringi musik kekinian yang bikin semangat",
    accent: "#FF6B35",
  },
  {
    icon: Music,
    title: "Asik",
    subtitle: "Musik Hits",
    description: "Playlist lagu-lagu hits Indonesia & internasional",
    accent: "#00D4FF",
  },
  {
    icon: Users,
    title: "Ramah",
    subtitle: "Komunitas",
    description: "Suasana kekeluargaan, cocok untuk semua umur",
    accent: "#AFFF00",
  },
];
