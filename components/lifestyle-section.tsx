...
const lifestyleImages = [
  {
    query: "young professional working late night creative studio laptop",
    aspect: "portrait",
  },
  { query: "athlete fitness workout gym energy sport", aspect: "landscape" },
  {
    query: "content creator streaming setup neon lights gaming",
    aspect: "square",
  },
  {
    query: "student studying library books coffee late night",
    aspect: "landscape",
  },
  {
    query: "skateboarder urban street style sunset cityscape",
    aspect: "portrait",
  },
...
const testimonials = [
  {
    handle: "@ririzumba",
    text: "Seru banget! Baru pertama nyoba Zumba di Terong Zumba, langsung ketagihan! Instrukturnya asik dan ramah 🔥",
    likes: "2.4k",
  },
  {
    handle: "@fitnessbudi",
    text: "Badan jadi lebih segar, kalori kebakar habis. Tempatnya nyaman di Binong Curug, recommended!",
    likes: "1.8k",
  },
  {
    handle: "@sari_olga",
    text: "Akhirnya nemu tempat Zumba yang enak. Musiknya asik, suasananya kekeluargaan banget",
    likes: "956",
  },
];
