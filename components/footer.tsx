...
export function Footer() {
  ...
  const footerLinks = [
    {
      title: "Kelas",
      links: ["Zumba Basic", "Zumba Fusion", "Zumba Kids", "Private Session"],
    },
    {
      title: "Menu",
      links: ["Beranda", "Kelas", "Testimoni", "Kontak"],
    },
    {
      title: "Tentang",
      links: ["Tentang Kami", "Instruktur", "Lokasi", "FAQ"],
    },
    {
      title: "Lainnya",
      links: ["Kebijakan Privasi", "Syarat & Ketentuan", "Blog"],
    },
  ];
  ...
  return (
    <footer
      ref={footerRef}
      id="kontak"
      className="relative bg-[#121212] pt-16 pb-6 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            >
              ...
              <motion.div
                ...
                animate={
                  email.length > 0
                    ? { boxShadow: "0 0 20px rgba(175,255,0,0.2)" }
                    : { boxShadow: "none" }
                }
              />
            </motion.div>
            ...
            >
              ...
              >
                {isSubmitting ? "Mendaftarkan..." : "Daftar Newsletter"}
              </motion.span>
            </motion.button>
          </div>
          <motion.p
          ...
          >
            Dapatkan info jadwal & promo terbaru. No spam, just energi positif!
          </motion.p>
        </motion.div>
        ...
        >
          <p className="text-white/60 font-mono text-xs max-w-xl mx-auto leading-relaxed">
            Terong Zumba adalah tempat Zumba & Fitness di Binong Curug. Kami
            menghadirkan olahraga seru dengan musik asik, instruktur
            profesional, dan suasana kekeluargaan. Bakar kalori, sehatkan tubuh!
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-white/40 font-mono text-xs">
            © 2026 Terong Zumba. All rights reserved.
          </p>
