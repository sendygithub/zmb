        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <motion.div style={{ opacity }} className="space-y-5">
            ...
            <div className="space-y-1 overflow-hidden">
              ...
              >
                Zumba seru, badan sehat, energi positif. Gabung sekarang di
                Binong Curug!
              </motion.p>
            </div>
            ...
            >
              {["Bakar Kalori", "Gerak Seru", "Musik Asik", "Tubuh Sehat"].map(
                (benefit, i) => (
                  <motion.div
                    key={benefit}
            ...
            >
              ...
              >
                <Image
                  ...
                  alt="Terong Zumba - Zumba & Fitness"
                  width={350}
                  height={525}
