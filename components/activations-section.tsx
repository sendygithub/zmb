...
const activations = [
  {
    ...
    description:
      "Berada di Binong Curug, akses mudah dari mana saja. Cocok untuk warga Curug, Serpong, dan sekitarnya.",
    cta: "Lihat Peta",
  },
  {
    icon: Clock,
    ...
    description:
      "Kelas tersedia pagi, siang, dan malam. Pilih waktu yang paling cocok untuk kamu.",
    cta: "Lihat Jadwal",
  },
  {
    icon: Users,
    ...
    description:
      "Didampingi instruktur Zumba bersertifikat yang asik, sabar, dan berpengalaman.",
    cta: "Kenali Instruktur",
  },
  {
    icon: Phone,
    title: "Hubungi Kami",
    description:
      "Punya pertanyaan? DM atau chat aja. Kami siap bantu kamu mulai perjalanan Zumba-mu!",
    cta: "WhatsApp Kami",
  },
];
...
export function ActivationsSection() {
  ...
  return (
    <section id="program" className="relative py-16 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          >
            Terong Zumba berlokasi di Binong Curug. Yuk, datang dan rasakan
            serunya Zumba bareng kami!
          </motion.p>
        </motion.div>
